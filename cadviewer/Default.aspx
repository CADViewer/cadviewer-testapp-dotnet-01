    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
			...
			<tr style="background-color:rgb(255,255,255)" height="100px" >
				...
				<td width="30%" style="vertical-align:top">
					  <p><span><strong>3) Image Space Objects: </strong> Control Space Icon Objects to interactively add and manage on the canvas. <br>See file: <strong><a href="./html/CADViewer_space_image_objects_680.html">CADViewer_space_image_objects_680.html.</strong></a></span></p>
				...
				<td width="30%" style="vertical-align:top">
					  <p><span><strong>4) Space Objects: </strong> Control Space Objects combining icons and test, for insert, move and modify through API commands. <br>See file: <strong><a href="./html/CADViewer_autonomous_space_objects_680.html">CADViewer_autonomous_space_objects_680.html.</strong></a></span></p>
