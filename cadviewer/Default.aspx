    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
			...
			<tr style="background-color:rgb(255,255,255)" height="100px" >
				...
				<br>See file: <strong><a href="./html/CADViewer_fileloader_70.html">CVJS_fileloader_70.html.</strong></a>
				<br>Drawing via Url: <strong><a href="./html/CADViewer_fileloader_70.html?drawing_name=../content/drawings/dwg/City_base_map.dwg">CVJS_fileloader_70.html?drawing_name=../my.dwg</strong></a>
				
				</span> </p>

					<a href="./html/CADViewer_fileloader_70.html"><img src="./html/index_images/cvjs_file_loader_09.png" width="383" height="275" alt="Tailor Made logo" /></a>
				</td>
				<td>
					<img  src="./html/index_images/5x5.png" width="5" height="5" />
				</td>
				...
				<br>See file: <strong><a href="./html/CADViewer_space_objects_canvas_API_70.html">CADViewer_space_objects_canvas_API_70.html.</strong></a>
				<br>
				<br>
				</span> </p>

					<a href="./html/CADViewer_space_objects_canvas_API_70.html"><img src="./html/index_images/cvjs_space_objects_10.png" width="416" height="232" alt="Tailor Made logo" /></a>
				</td>
				<td>
						<img  src="./html/index_images/5x5.png"  width="5" height="5" />
				</td>
			...
			<tr style="background-color:rgb(255,255,255)" height="100px" >
				...
				<td width="30%" style="vertical-align:top">
					  <p><span><strong>3) Image Space Objects: </strong> Control Space Icon Objects to interactively add and manage on the canvas. <br>See file: <strong><a href="./html/CADViewer_space_image_objects_70.html">CADViewer_space_image_objects_70.html.</strong></a></span></p>
					<a href="./html/CADViewer_space_image_objects_70.html"><img src="./html/index_images/space-icons_11.png" width="382" height="239" alt="Tailor Made logo" /></a>
				...
				<td width="30%" style="vertical-align:top">
					  <p><span><strong>4) Space Objects: </strong> Control Space Objects combining icons and test, for insert, move and modify through API commands. <br>See file: <strong><a href="./html/CADViewer_autonomous_space_objects_70.html">CADViewer_autonomous_space_objects_70.html.</strong></a></span></p>
					<a href="./html/CADViewer_autonomous_space_objects_70.html"><img src="./html/index_images/cvjs_file_space_objects_10.png" width="382" height="239" alt="Tailor Made logo" /></a>
				</td>
				<td>
						<img  src="./html/index_images/5x5.png"  width="5" height="5" />
				</td>
